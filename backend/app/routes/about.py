...
async def get_about_data():
    ...
    if not doc:
        ...
        initial_data = AboutData(
            ...
            story_paragraphs=[
                "Sahajanand Jewellers was started in Nadiad in 1924 by a young goldsmith who believed jewellery should outlive its wearer. Today, four generations on, we still believe the same thing.",
